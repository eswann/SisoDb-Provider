...
{
    internal class GetIdsHelper : ReadHelper
    {
        public GetIdsHelper(ISisoDatabase db, IDbClient dbClient, IDbQueryGenerator queryGenerator)
            : base(db, dbClient, queryGenerator)
        {
        }
