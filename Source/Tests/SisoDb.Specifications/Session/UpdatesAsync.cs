...
namespace SisoDb.Specifications.Session
{
	class UpdatesAsync
    {
        ...
        public class when_guiditem_and_updating_async_two_of_four_items : SpecificationBase
        {
            ...
            Because of = () =>
            {
                using (var session = TestContext.Database.BeginSession())
                {
                    ...
                    session.UpdateAsync(_structures[1]).Wait();

                    _structures[2].Value += 10;
                    session.UpdateAsync(_structures[2]).Wait();
                }
            };
        ...
        public class when_stringitem_and_updating_async_two_of_four_items : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update")]
        public class when_identityitem_and_updating_async_two_of_four_items : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update")]
        public class when_bigidentityitem_and_updating_async_two_of_four_items : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        public class when_uniqueguiditem_and_updating_async_from_unique_to_non_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
            {
                CaughtException = Catch.Exception(() =>
                {
                    using (var session = TestContext.Database.BeginSession())
                    {
                        ...
                        session.UpdateAsync(_structures[0]).Wait();
                    }
                });
            };
        ...
        [Subject(typeof(ISession), "Update (uniques)")]
        public class when_uniqueidentityitem_and_updating_async_from_unique_to_non_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update (uniques)")]
        public class when_uniquebigidentityitem_and_updating_async_from_unique_to_non_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update (uniques)")]
        public class when_uniqueguiditem_and_updating_async_from_unique_to_other_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update (uniques)")]
        public class when_uniqueidentityitem_and_updating_async_from_unique_to_other_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
        ...
        [Subject(typeof(ISession), "Update (uniques)")]
        public class when_uniquebigidentityitem_and_updating_async_from_unique_to_other_unique : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
