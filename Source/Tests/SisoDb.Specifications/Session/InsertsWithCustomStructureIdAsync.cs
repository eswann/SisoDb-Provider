	...
	class InsertsWithCustomStructureIdAsync
	{
		...
		public class when_structure_has_structure_id_with_name_matching_interface_and_query_targets_first_and_last_of_four_items_async : SpecificationBase
		{
			Establish context = () =>
			{
                ...
                TestContext.Database.UseOnceTo().InsertManyAsync<IEvent>(_structures).Wait();
			};
		...
		public class when_structure_has_type_named_structure_id_and_query_targets_first_and_last_of_four_items_async : SpecificationBase
		{
			Establish context = () =>
			{
				TestContext = TestContextFactory.Create();
		...
		[Subject(typeof(ISession), "Insert (custom structure id)")]
		public class when_structure_has_id_named_structure_id_and_query_targets_first_and_last_of_four_items_async : SpecificationBase
		{
			Establish context = () =>
			{
				TestContext = TestContextFactory.Create();
