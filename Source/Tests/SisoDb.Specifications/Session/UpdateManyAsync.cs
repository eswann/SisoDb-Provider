	...
	class UpdateManyAsync
	{
		...
		public class when_the_second_of_two_new_structures_does_not_get_an_identity_id_async : SpecificationBase
		{
			...
			Because of = () => CaughtException = Catch.Exception(() =>
			{
				using (var session = TestContext.Database.BeginSession())
				{
					session.UpdateManyAsync<ItemForPropChange>(
        ...
        public class when_the_second_of_two_new_structures_does_not_get_a_guid_id_async : SpecificationBase
		{
			Establish context = () =>
			{
			...
			Because of = () => CaughtException = Catch.Exception(() =>
			{
				using (var session = TestContext.Database.BeginSession())
				{
                    session.UpdateManyAsync<GuidItemForPropChange>(
						i => i.StructureId == _orgItem1Id || i.StructureId == _orgItem2Id,
						item =>
						{
							if (item.StructureId == _orgItem2Id)
		...
		[Subject(typeof(ISession), "Update many")]
        public class when_the_second_of_two_new_structures_does_get_a_new_identity_id_async : SpecificationBase
		{
			Establish context = () =>
			{
				var orgItem1 = new ItemForPropChange { Int1 = 142, String1 = "A" };
		...
		[Subject(typeof(ISession), "Update many")]
        public class when_the_second_of_two_new_structures_does_get_a_new_guid_id_async : SpecificationBase
		{
			Establish context = () =>
			{
				var orgItem1 = new GuidItemForPropChange { Int1 = 142, String1 = "A" };
		...
		[Subject(typeof(ISession), "Update many")]
        public class when_all_identity_items_are_updated_async : SpecificationBase
		{
			Establish context = () =>
			{
				var orgItem1 = new ItemForPropChange { Int1 = 142, String1 = "A" };
		...
		[Subject(typeof(ISession), "Update many")]
        public class when_all_guid_items_are_updated_async : SpecificationBase
		{
			Establish context = () =>
			{
				var orgItem1 = new GuidItemForPropChange { Int1 = 142, String1 = "A" };
