...
namespace SisoDb.Specifications.Session
{
    class UpdatesOfSingleValuesAsync
    {
        ...
        public class when_updating_async_item_with_single_string_member_to_null : SpecificationBase
        {
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleStringMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_datetime_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleDateTimeMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_int_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleIntMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_long_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleLongMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_bool_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleBoolMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_decimal_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleDecimalMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_single_double_member_to_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<SingleDoubleMember>(_item.StructureId, i => i.Value = null).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_string_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.StringElements.Add(new StringElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_datetime_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.DateElements.Add(new DateTimeElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_int_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.IntElements.Add(new IntElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_long_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.LongElements.Add(new LongElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_bool_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.BoolElements.Add(new BoolElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_decimal_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.DecimalElements.Add(new DecimalElement { Value = null })).Wait();
        ...
        public class when_updating_async_item_with_array_of_single_double_member_with_member_having_null : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
            ...
            Because of = () =>
                TestContext.Database.UseOnceTo().UpdateAsync<Root>(_item.StructureId, i => i.DoubleElements.Add(new DoubleElement { Value = null })).Wait();
