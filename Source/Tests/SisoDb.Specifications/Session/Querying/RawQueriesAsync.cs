    ...
    class RawQueriesAsync
    {
        ...
        public class when_raw_query_async_returns_no_result : SpecificationBase
        {
            ...
            Because of = () =>
            {
                ...
                {
                    _fetchedStructures = session.Advanced.RawQueryAsync<QueryGuidItem>(query).Result.ToList();
                }
            };
        ...
        public class when_raw_query_async_returns_no_json_result : SpecificationBase
        {
            ...
            Because of = () =>
            {
                ...
                using (var session = TestContext.Database.BeginSession())
                {
                    _fetchedStructures = session.Advanced.RawQueryAsJsonAsync<QueryGuidItem>(query).Result.ToList();
                }
            };
        ...
        public class when_raw_query_async_with_parameters : SpecificationBase
        {
            Establish context = () =>
            {
        ...
        [Subject(typeof(ISession), "Raw Query as Json")]
        public class when_raw_query_async_with_parameters_returning_json : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.CreateAsync();
