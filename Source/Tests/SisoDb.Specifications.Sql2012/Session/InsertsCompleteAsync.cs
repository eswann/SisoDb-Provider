...
namespace SisoDb.Specifications.Session
{
	class InsertsCompleteAsync
    {
        ...
        public class when_inserting_async_complete_guid_entity_with_populated_hierarchy_using_type : SpecificationBase
        {
            ...
            Because of =
                () => TestContext.Database.UseOnceTo().InsertAsync(typeof(CompleteGuidEntity), _structure).Wait();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_two_complete_guid_entities_with_populated_hierarchy_using_type : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
            ...
            Because of =
                () => TestContext.Database.UseOnceTo().InsertManyAsync(typeof(CompleteGuidEntity), _structures).Wait();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_complete_guid_entity_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_two_complete_guid_entities_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_complete_string_entity_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_two_complete_string_entities_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_complete_identity_entity_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_two_complete_identity_entities_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_complete_big_identity_entity_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
        ...
        [Subject(typeof(ISession), "Insert (complete)")]
        public class when_inserting_async_two_complete_big_identity_entities_with_populated_hierarchy : SpecificationBase
        {
            Establish context = () =>
            {
                TestContext = TestContextFactory.Create();
